...
# nohup accelerate launch train.py --use_wandb --epochs 600 --enc_dropout 0 --dec_dropout 0.01 --weight_decay 0 --lr 1e-3 --save_ver M \
#                       --seed 999 --dim_reduce_factor 3 --batch_size 256 --scale_energy_loss 1000 --conv2lin #--debug
# nohup accelerate launch train.py --use_wandb --epochs 600 --enc_dropout 0 --dec_dropout 0.01 --weight_decay 0 --lr 1e-3 --save_ver S \
...
export XLA_FLAGS=--xla_gpu_cuda_data_dir="/opt/conda" ## necessary to prevent JIT compilation error
...
# nohup python tf_train.py --use_wandb --epochs 10 --enc_dropout 0 --dec_dropout 0 --weight_decay 0 --lr 1e-3 --save_ver tf_S \
#                       --seed 999 --dim_reduce_factor 3.5 --batch_size 256 --scale_energy_loss 1000 --conv2lin --debug
